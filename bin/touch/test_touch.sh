...
TEST_NAME="[Touch] - [Touch panel drag and draw]"
TEST_PARAMS=$1
TEST_PROMPT_PRE="Lanch touch panel test utility"
TEST_PROMPT_POST="Was the multi-touch success?"
