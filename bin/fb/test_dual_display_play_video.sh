...
TEST_NAME="[DUAL DISPLAY] - [Show colorbar and playback audio to HDMI, play vido to MIPI-DSI]"
TEST_PARAMS=
...
{
	gplay-1.0 $DSI_VIDEO_PATH --video-sink=waylandsink --audio-sink="alsasink device=hw:1" & 
