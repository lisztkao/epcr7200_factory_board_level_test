...
TEST_NAME="[LVDS] - [Play video and show colorbar to LVDS]"
TEST_PARAMS=$1
TEST_PROMPT_PRE="Look at the LVDS Display"
TEST_PROMPT_POST="Did you see the video and colorbar on the LVDS display?"
function Test_Function
{
	systemctl stop weston
	timeout 2s gst-launch-1.0 filesrc location=/home/root/advtest-factory/$LVDS_VIDEO_PATH ! avidemux ! decodebin ! imxvideoconvert_g2d ! queue ! autovideosink
