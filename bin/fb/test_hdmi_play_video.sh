...
TEST_NAME="[HDMI] - [Playback video to HDMI]"
TEST_PARAMS=
TEST_PROMPT_PRE="Look at the HDMI Display"
TEST_PROMPT_POST="Did you see the video and hear the audio?"
function Test_Function
{
	gplay-1.0 $HDMI_VIDEO_PATH  --audio-sink='alsasink device="hw:'"$HDMI_AUDIO_DEV"',0"' &
	return 0
}
